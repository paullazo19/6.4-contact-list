...
/***/ function(module, exports, __webpack_require__) {
	...
	var _DetailView = __webpack_require__(221);
	...
	(0, _reactDom.render)(_react2.default.createElement(
	  ...
	  _react2.default.createElement(_reactRouter.Route, { path: '/:lastName/:firstName/:email/:phoneNumber/:city/:state/:photo', component: _DetailView2.default })
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        ...
	        _react2.default.createElement(
	          'nav',
	          { className: 'listView__contacts' },
	          this.props.contacts.map(function (contact, i) {
	            return _react2.default.createElement(
	              _reactRouter.Link,
	              { to: '/' + contact.lastName + '/' + contact.firstName + '/' + contact.email + '/' + contact.phoneNumber + '/' + contact.city + '/' + contact.state + '/' + contact.photo, key: i, className: 'listView__contact' },
	              _react2.default.createElement('img', { className: 'listView__contact--image', src: './images/' + contact.photo }),
	              _react2.default.createElement(
	                'li',
	                { className: 'listView__contact--fullName' },
	                contact.firstName,
	                ' ',
	                contact.lastName
	              )
	...
	exports.default = _react2.default.createClass({
	  ...
	  render: function render() {
	    return _react2.default.createElement(
	      ...
	      _react2.default.createElement(
	        'div',
	        { className: 'detailView__header' },
	        _react2.default.createElement(
	          _reactRouter.Link,
	          { to: '/' },
	          _react2.default.createElement('i', { className: 'fa fa-arrow-left fa-2x detailView__backIcon' })
	        ),
	        _react2.default.createElement('img', { className: 'detailView__photo', src: '/images/' + this.props.params.photo })
	      ),
	      _react2.default.createElement(
	        'ul',
	        { className: 'detailView__list' },
	        _react2.default.createElement(
	          'li',
	          { className: 'detailView__contactItem' },
	          _react2.default.createElement('i', { className: 'fa fa-user detailView__contactIcon' }),
	          _react2.default.createElement(
	            'p',
	            { className: 'detailView__contactInfo detailView__contactName' },
	            ' ',
	        ...
	        _react2.default.createElement(
	          'li',
	          { className: 'detailView__contactItem' },
	          _react2.default.createElement('i', { className: 'fa fa-envelope detailView__contactIcon' }),
	          _react2.default.createElement(
	            'p',
	            { className: 'detailView__contactInfo detailView__contactEmail' },
	            ' ',
	        ...
	        _react2.default.createElement(
	          'li',
	          { className: 'detailView__contactItem' },
	          _react2.default.createElement('i', { className: 'fa fa-mobile detailView__contactIcon' }),
	          _react2.default.createElement(
	            'p',
	            { className: 'detailView__contactInfo' },
	            ' ',
	        ...
	        _react2.default.createElement(
	          'li',
	          { className: 'detailView__contactItem' },
	          _react2.default.createElement('i', { className: 'fa fa-globe detailView__contactIcon' }),
	          _react2.default.createElement(
	            'p',
	            { className: 'detailView__contactInfo ' },
	            ' ',
	            ...
	            _react2.default.createElement(
	              'span',
	              { className: 'detailView__contactState' },
